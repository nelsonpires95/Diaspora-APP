...
public class NearbyPlacesActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.action_embaixadas:
                        nearByPlace("embassy");
                        break;

                    case R.id.action_alojamento:
                        nearByPlace("market");
                        break;
                    ...
                    case R.id.action_ensino:
                        nearByPlace("university");
                        break;
                    default:
                        break;
                }
        ...
        mService.getNearbyPlaces(url)
                .enqueue(new Callback<MyPlaces>() {
                    ...
                    public void onResponse(Call<MyPlaces> call, Response<MyPlaces> response) {
                        ...
                        currentPlace = response.body(); //Remeber assign value for currentPlace
                        ...
                        if(response.isSuccessful())
                        {
                            for (int i=0; i<response.body().getResults().length; i++)
                            {
                                ...
                                if(placeType.equals("embassy"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.marker_embassy));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Make evenet click market
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener(){
            @Override
            public boolean onMarkerClick(Marker marker){
                //When user select a category, just get result of place and assign to static variable
                Common.currentResult = currentPlace.getResults()[Integer.parseInt(marker.getSnippet())];
                //start new activity
                startActivity(new Intent(NearbyPlacesActivity.this, ViewPlaceActivity.class));
                return true;
            }
        });
